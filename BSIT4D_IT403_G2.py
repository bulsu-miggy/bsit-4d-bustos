...
if x == "yes" or x == "Yes" or x == "YES":
    ...
    while i < 10: #10 loops for 10 questions
        ...
        if (y == 1): #question 1
            print(counter,". It has a shorthand that requires it to be in a list.", sep='') #separator for spacing
            ...
            print(counter,". A collection type that is ordered, indexed and just like the arrays declared in other languages. ", sep='')
            QuestionNum.remove(y)
            print("\n","Answer:")
            answer = input()
            os.system('cls||clear')
            ...
            print(counter,". A collection type just like lists but it is immutable. ", sep='')
            QuestionNum.remove(y)
            print("\n","Answer:")
            answer = input()
            os.system('cls||clear')
            ...
            print(counter,". A collection type that are unordered, changeable, and indexed.", sep='')
            QuestionNum.remove(y)
            print("\n","Answer:")
            answer = input()
            os.system('cls||clear')
            ...
            print(counter,". An unordered collection, does not record element position or order of insertion, and could be heterogeneous.", sep='')
            QuestionNum.remove(y)
            print("\n","Answer:")
            answer = input()
            os.system('cls||clear')
            ...
            print(counter,". Special characters used in set to enclose its contents.", sep='')
            QuestionNum.remove(y)
            print("\n","Answer:")
            answer = input()
            os.system('cls||clear')
            ...
            print(counter,". Special characters used in dictionaries to enclose its contents.", sep='')
            QuestionNum.remove(y)
            print("\n","Answer:")
            answer = input()
            os.system('cls||clear')
            ...
            print(counter,". Special characters used in tuples to enclose its contents.", sep='')
            QuestionNum.remove(y)
            print("\n","Answer:")
            answer = input()
            os.system('cls||clear')
            ...
            print(counter,". Special characters used in lists to enclose its contents.", sep='')
            QuestionNum.remove(y)
            print("\n","Answer:")
            answer = input()
            os.system('cls||clear')
